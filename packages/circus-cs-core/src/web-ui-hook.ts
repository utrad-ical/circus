...
export async function failed(jobId: string, result: string, tmpPluginInputDir: string, tmpPluginOutputDir: string): Promise<void>
{
	console.log('Notice failed');
}

export async function invalidated(jobId: string, result: string, tmpPluginInputDir: string, tmpPluginOutputDir: string, e: any): Promise<void>
{
	console.log('Notice invalidated');
}

export async function finished(jobId: string, result: string, tmpPluginInputDir: string, tmpPluginOutputDir: string): Promise<void>
{
