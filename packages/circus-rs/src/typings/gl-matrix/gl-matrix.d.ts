...
declare module "gl-matrix" {
    interface vec2 {
       ...
       * @function
       */
      forEach<T>(a: floats[], stride: number, offset: number, count: number, fn: (a: floats, b: floats, arg: T) => void, arg: T): floats[];
    ...
    interface vec3 {
       ...
       * @returns {vec3} out
       */
      hermite(out: floats, a: floats, b: floats, c: floats, d: floats, t: number): floats;
       ...
       * @returns {vec3} out
       */
      bezier(out: floats, a: floats, b: floats, c: floats, d: floats, t: number): floats;
    ...
    interface mat4 {
       ...
       * @returns {mat4} out
       */
      fromRotationTranslationScale(out: floats, q: floats, v: floats, s: floats): floats;
       ...
       * @returns {mat4} out
       */
      fromRotationTranslationScaleOrigin(out: floats, q: floats, v: floats, s: floats, o: floats): floats;
       ...
       * @returns {mat4} out
       */
      frustum(out: floats, left: number, right: number, bottom: number, top: number, near: number, far: number): floats;
       ...
       * @returns {mat4} out
       */
      perspective(out: floats, fovy: number, aspect: number, near: number, far: number): floats;
       ...
       * @returns {mat4} out
       */
      perspectiveFromFieldOfView(out: floats, fov: number, near: number, far: number): floats;
       ...
       * @returns {mat4} out
       */
      ortho(out: floats, left: number, right: number, bottom: number, top: number, near: number, far: number): floats;
    ...
    interface quat {
       ...
       * @returns {quat} out
       */
      sqlerp(out: floats, a: floats, b: floats, c: floats, d: floats, t: number): floats;
