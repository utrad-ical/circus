...
describe('Rectangle', function() {
  describe('rectangleEquals', function() {
    it('must return true when two rectangles are the same', function() {
      const r1 = { origin: [0, 0], size: [3, 3] };
      const r2 = { origin: [0, 0], size: [3, 3] };
      const r3 = { origin: [0, 1], size: [1, 3] };
  ...
  describe('intersectionOfTwoRectangles', function() {
    it('calculates intersection of two rectangles', function() {
      const r1 = { origin: [0, 0], size: [3, 3] };
      const r2 = { origin: [1, 2], size: [4, 4] };
      const r3 = { origin: [1, 1], size: [1, 1] };
      const r4 = { origin: [-1, -1], size: [5, 5] };
      const r5 = { origin: [3, 3], size: [3, 3] };
      let intersect;
