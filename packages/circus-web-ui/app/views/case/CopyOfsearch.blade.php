...
<div class="page_contents_outer">
				...
				<div id="search_condition_outer">
					<table class="common_table al_l mar_b_10">
						...
						<tr>
							...
							<td>
								{{Form::select('project', array('Project1' => 'Project1', 'Project2' => 'Project2', 'Project3' => 'Project3'))}}
							</td>
							<th>
								{{Form::label('caseID', 'Case ID')}}
							</th>
							<td>
								{{Form::text('caseID', array("class" => "common_input_text w_200"))}}
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								{{Form::text('patientID', array("class" => "common_input_text w_200"))}}
							</td>
							<th>
								{{Form::label('patientName', 'Patient Name')}}
							</th>
							<td>
								{{Form::text('parientName', array("class" => "common_input_text w_200"))}}
							</td>
						</tr>
						<tr>
							<th>
								{{Form::label('inspectionDate', 'Inspection date')}}
							</th>
							<td colspan="3">
								{{Form::text('insepctionDate', array("class" => "common_input_text w_200 datepicker"))}}
							</td>
						</tr>
					</table>
					...
					{{Form::open(['url' => 'case/search', 'method' => 'POST'])}}
						<p class="submit_area">
	...
	</ul><!-- #EndLibraryItem --></div><!--/.page_unique-->
	@include('common.navi')
	<div class="clear">&nbsp;</div>
</div>
