...
<script type="text/javascript" src="../js/img_edit.js"></script>
<title>Series Detail | site-title</title>
</head>
...
<div id="header">
	<div class="header_logo">
		<a href="../home.html">
			<img src="../img/common/header_logo.png" width="192" height="40" alt="CIRCUS">
		</a>
	</div>
	<form>
		<ul id="btn_area">
			<li class="color_btn color_btn_white">
				<label>
					<input type="radio" name="color_mode" value="0" class="color_select" id="color_mode_white" checked>
				</label>
			</li>
			<li class="color_btn color_btn_black">
				<label>
					<input type="radio" name="color_mode" value="1" class="color_select" id="color_mode_black">
				</label>
			</li>
...
<!-- #EndLibraryItem --><div class="page_contents_outer">
