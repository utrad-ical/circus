//customized by SPiritek.Inc Aug 2014
...
$.fn.simpleColorPicker = function(options) {
	var defaults = {
			...
			hideEffect: '',
			onChangeColor: true,
		  onChangeEvent:	''		//added by Spiritek
	};
	...
	return this.each(function() {
			...
			box.find('li.color-box').click(function() {
				...
				//added by Spiritek
				if (opts.onChangeEvent	==	true){
					txt.trigger('change');
				}
				hideBox(box);
			});

			//changed by Spiritek because of Jquery version
			// change the method from [bind] to [on]
