// This file just re-exports some components in React-Bootstrap
// used in our project. This should reduce the number of import lines
// in other components while keeping the size of the bundle small.

export { default as Alert } from 'react-bootstrap/lib/Alert';

export { default as Button } from 'react-bootstrap/lib/Button';
export { default as SplitButton } from 'react-bootstrap/lib/SplitButton';
