...
const AttributeSchemaEditor = props => {
	...
	return <span className='attribute-schema-editor'>
...
const ArrayOfAttributeSchema = et.arrayOf(AttributeSchemaEditor, newAttributeItem);

const AttributeSchemaArrayEditor = props => <div>
