...
export default class GroupAdmin extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.editorProperties[1].editor = et.multiSelect(privileges, {
      type: 'checkbox'
    });
    this.editorProperties[2].editor = et.multiSelect(domains, {
      type: 'checkbox'
    });
    ...
    for (let i = 3; i <= 7; i++)
      this.editorProperties[i].editor = projectSelect;
